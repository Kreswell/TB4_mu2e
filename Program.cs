...
namespace TB_mu2e
{
    ...
    public class Run
    {
        ...
        public Run()
        {
            ...
            try
            {
                StreamWriter sw = File.AppendText("c:\\data\\run_list.txt");
            ...
            {
                StreamWriter sw1 = File.CreateText("c:\\data\\run_list.txt");
        ...
        public void ActivateRun()
        {
            ...
            if (sw == null)
            {
                ...
                try
                {
                    ...
                    StreamWriter sw1 = File.AppendText("c:\\data\\run_list.txt");
